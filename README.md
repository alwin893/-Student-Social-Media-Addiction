...
| ├── **📂 [Documentation](Documentation/)**                                                          | Contains all project documentation files.                              |
...
| │ └── **📂 [PowerBI_Screenshots](PowerBI_Dashboard/PowerBI_Screenshots/)**                          | Dashboard preview images.                                              |
...
| ├── [README.md](README.md)                                                                          | Main documentation file for the project.                               |
| └── [LICENSE](LICENSE)                                                                              | License information for open-source sharing.                           |
