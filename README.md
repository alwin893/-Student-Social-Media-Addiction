...
| ├── **📂 Documentation/**             | Contains all project documents.                                |
| │ ├── `Project_Report.pdf`            | Detailed project report with objectives, methods, and results. |
| │ ├── `ER_Diagram.png`                | Entity Relationship Diagram of the database.                   |
| │ └── `Data_Dictionary.xlsx`          | Describes all tables, fields, and data types.                  |
| ├── **📂 SQL_Files/**                 | SQL scripts for data creation and analysis.                    |
| │ ├── `create_tables.sql`             | SQL script to create database tables.                          |
| │ ├── `insert_sample_data.sql`        | Sample data insertion queries.                                 |
| │ └── `analysis_queries.sql`          | SQL analysis and insight queries.                              |
| ├── **📂 PowerBI_Dashboard/**         | Power BI visualization files and resources.                    |
| │ ├── `Student_Social_Media.pbix`     | Power BI dashboard file.                                       |
| │ ├── `Dashboard_Theme.md`            | Power BI color and theme documentation.                        |
| │ └── **📂 PowerBI_Screenshots/**     | Folder containing dashboard preview images.                    |
| │    ├── `overview_page.png`          | Overview dashboard page.                                       |
| │    ├── `performance_insights.png`   | Academic performance insights.                                 |
| │    └── `health_analysis.png`        | Sleep and mental health visualization.                         |
| ├── **📂 Assets/**                    | Contains images and visual assets.                             |
| │ ├── `Logo.png`                      | Project or organization logo.                                  |
| │ └── `Preview_Banner.png`            | GitHub banner or cover image.                                  |
